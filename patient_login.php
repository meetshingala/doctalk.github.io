		...
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Patient Login</h3>
			<div class="formstyle" style="float: right;padding:20px;border: 1px solid lightgrey;margin-right:500px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
				<form action="" method="post" class="text-center form-group">
					<label>
						 <input type="email" name="email"  placeholder="email" required style="margin-left: 26px;width: 200px;border-radius: 3px;">
					</label><br><br>
					<label>
					     <input type="password" name="password"  placeholder="password" required style="margin-left: 26px;width: 200px;border-radius: 3px;">
					</label><br><br>
