		...
		<h3 class="text-center" style="background-color:#272327;color: #fff;">My Details</h3>
			<div class="formstyle" style="float: right;padding:20px;border: 1px solid lightgrey;margin-right:500px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
				<form action="" method="post" class="text-center form-group">
					...
					<label>
						Blood Group: <input type="bgroup" name="bgroup" value="<?php echo $bgroup; ?>" placeholder="bgroup" requierd >
					</label><br><br>
...
<br><br><br>
			...
			<!-- update information -->
				...
				<?php
							...
							$sql="UPDATE patient SET name='" .$_POST["name"]. "' ,age='" .$_POST["age"]."' , contact='" .$_POST["contact"]. "',address='" .$_POST["address"]. "', bgroup='".$_POST["bgroup"]."' WHERE email='" .$_SESSION["email"]. "'";
